									...
									button_4.addActionListener(new ActionListener()
													{
															...
															public void actionPerformed(ActionEvent ae)
																{
																	generateReport("select * from employees");
						    			...
						    			try
						    				{
						    					...
						    					cn=DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/company","root","Boot");
						    			...
						    			try
						    				{
						    						...
						    						PreparedStatement ps=cn.prepareStatement("select * from employees");
						   ...
						   public void insertRecord()
						   		{
						   			try {
						   						...
						   						if(txt2.getText().length()>0 && txt3.getText().length()>0)
						   						{
						   							...
						   							PreparedStatement ps=cn.prepareStatement("insert into employees(name,salary) values(?,?)");
						   							ps.setString(1,name);
						   	  ...
						   	  public void updateRecord()
						   		{
						   			try {
						   						...
						   						if(txt2.getText().length()>0 && txt3.getText().length()>0)
						   						{
						   							...
						   							PreparedStatement ps=cn.prepareStatement("update employees set name=?,salary=? where code=?");
						   							ps.setString(1,name);
						   							ps.setDouble(2,salary);
						   		 ...
						   		 public void deleteRecord()
						   		{
						   			try {
						   						...
						   						if(txt2.getText().length()>0 && txt3.getText().length()>0)
						   						{
						   							...
						   							PreparedStatement ps=cn.prepareStatement("delete from employees where code=?");
